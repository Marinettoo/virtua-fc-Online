                                    ...
                                    <div class="px-5 py-3 bg-amber-50 border-b border-amber-200">
                                        <div class="flex items-center justify-between gap-2">
                                            <h4 class="font-semibold text-sm text-slate-900 flex items-center gap-2">
                                                ...
                                                <span class="text-xs font-normal text-slate-400" x-text="'(' + players.length + '/' + shortlistMax + ')'"></span>
                                            </h4>
                                                                ...
                                                                <form :action="preContractRoute(player.id)" method="POST" class="space-y-2">
                                                                    ...
                                                                    <div class="flex items-center gap-2" x-data="{
                                                                        ...
                                                                        <div class="inline-flex items-stretch border border-slate-300 rounded-lg overflow-hidden h-[36px]">
                                                                            ...
                                                                            <input type="text" readonly :value="display" class="min-h-[32px] sm:min-h-0 w-28 text-xs text-center font-semibold text-slate-900 bg-white border-x border-y-0 border-slate-300 outline-none cursor-default focus:outline-none focus:ring-0 focus:border-slate-300">
